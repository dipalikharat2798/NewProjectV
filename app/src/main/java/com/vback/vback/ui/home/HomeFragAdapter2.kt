...
class HomeFragAdapter2(
    val arrayList: ArrayList<RecyclerFirstModel>,
    val context: Context
) : RecyclerView.Adapter<HomeFragAdapter2.HomeViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.dash_recy2_item_view, parent, false)
        return HomeFragAdapter2.HomeViewHolder(view)
    }
